    ...
    <div class="min-h-screen flex">
        ...
        <div class="flex-1 p-10 overflow-y-auto bg-slate-50">
            ...
            <div class="bg-white rounded-3xl shadow-lg border border-slate-100 overflow-hidden relative max-w-4xl">
                ...
                <form action="<?php echo e(route('marks.update', $mark->mark_id)); ?>" method="POST" class="p-10">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                        ...
                        <div>
                            ...
                            <select name="student_id" required class="w-full px-4 py-3.5 rounded-xl border border-slate-200 focus:outline-none focus:border-orange-500 bg-slate-50 focus:bg-white text-sm font-medium text-slate-700">
                                <?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($student->student_id); ?>" <?php echo e($mark->student_id == $student->student_id ? 'selected' : ''); ?>>
                        ...
                        <div>
                            ...
                            <select name="subject_id" required class="w-full px-4 py-3.5 rounded-xl border border-slate-200 focus:outline-none focus:border-orange-500 bg-slate-50 focus:bg-white text-sm font-medium text-slate-700">
                                <?php $__currentLoopData = $subjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($subject->subject_id); ?>" <?php echo e($mark->subject_id == $subject->subject_id ? 'selected' : ''); ?>>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="exam_name" value="<?php echo e($mark->exam_name); ?>" required class="w-full px-4 py-3.5 rounded-xl border border-slate-200 focus:outline-none focus:border-orange-500 bg-slate-50 focus:bg-white text-sm font-medium text-slate-700">
                        </div>

                        <!-- Marks -->
                        <div>
                            <label class="block text-sm font-bold text-slate-700 mb-2">Marks (0-100) <span class="text-red-500">*</span></label>
                            <input type="number" name="marks" id="marksInput" value="<?php echo e($mark->marks); ?>" min="0" max="100" required class="w-full px-4 py-3.5 rounded-xl border border-slate-200 focus:outline-none focus:border-orange-500 bg-slate-50 focus:bg-white text-sm font-black text-slate-800 text-lg">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="grade" id="gradeInput" value="<?php echo e($mark->grade); ?>" readonly required class="w-full px-4 py-3.5 rounded-xl border border-slate-200 bg-slate-100 text-sm font-black text-slate-800 text-lg cursor-not-allowed outline-none">
                        </div>
...
</html><?php /**PATH C:\xampp\htdocs\school_management_system\resources\views/marks/edit.blade.php ENDPATH**/ ?>