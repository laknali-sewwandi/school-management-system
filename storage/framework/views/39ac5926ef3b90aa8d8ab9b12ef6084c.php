    ...
    <div class="min-h-screen flex">
        ...
        <div class="flex-1 p-10 overflow-y-auto bg-slate-50">
            ...
            <div class="flex justify-between items-center mb-10">
                ...
                <a href="<?php echo e(route('attendances.create')); ?>" class="bg-gradient-to-r from-orange-500 to-amber-600 hover:from-orange-600 hover:to-amber-700 text-white font-bold py-3.5 px-6 rounded-xl shadow-lg transition-all duration-300 flex items-center transform hover:-translate-y-1">
                    <i class="fa-solid fa-clipboard-check mr-2"></i> Mark Attendance
                </a>
            </div>

            <form action="<?php echo e(route('attendances.index')); ?>" method="GET" class="mb-8 bg-white p-3 pr-4 rounded-2xl shadow-md border border-slate-100 flex gap-3 items-center">
                <div class="relative flex-1 group">
                    <i class="fa-solid fa-magnifying-glass absolute left-5 top-1/2 transform -translate-y-1/2 text-slate-400"></i>
                    <input type="text" name="search" value="<?php echo e($search ?? ''); ?>" placeholder="Search by student name, date or status..." 
                ...
                <?php if(isset($search) && $search != ''): ?>
                    <a href="<?php echo e(route('attendances.index')); ?>" class="bg-red-50 text-red-600 px-6 py-3 rounded-xl font-bold text-sm flex items-center hover:bg-red-100 transition-colors">
                    ...
                    <tbody class="text-slate-700 text-sm divide-y divide-slate-50">
                        ...
                        <tr class="hover:bg-orange-50/40 transition">
                            <td class="px-8 py-5 font-bold text-slate-600">
                                <i class="fa-regular fa-calendar text-slate-400 mr-2"></i> <?php echo e($attendance->date); ?>
                            ...
                            <td class="px-8 py-5">
                                <div class="flex items-center">
                                    <div class="h-10 w-10 rounded-full bg-blue-100 text-blue-700 flex items-center justify-center font-extrabold mr-4">
                                        <?php echo e($attendance->student ? strtoupper(substr($attendance->student->name, 0, 1)) : '?'); ?>

                                    </div>
                                    <div>
                                        <p class="font-extrabold text-slate-800"><?php echo e($attendance->student ? $attendance->student->name : 'Unknown Student'); ?></p>
                                        <p class="text-xs font-bold text-slate-400">ID: <?php echo e($attendance->student_id); ?></p>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="px-8 py-5">
                                <span class="font-bold text-slate-500 border border-slate-200 bg-slate-50 px-3 py-1 rounded-lg text-xs">
                                    ...
                                    <?php echo e($attendance->teacher ? $attendance->teacher->name : 'Teacher ID: ' . $attendance->teacher_id); ?>
                            ...
                            <td class="px-8 py-5">
                                <div class="flex justify-center gap-3">
                                         ...
                                         <a href="<?php echo e(route('attendances.edit', $attendance->attendance_id)); ?>" class="text-blue-600 hover:text-white bg-blue-50 hover:bg-blue-600 p-2.5 rounded-xl transition-all" title="Edit Record">
                                         <i class="fa-solid fa-pen-to-square w-4"></i>
                                         </a>

                                     <form action="<?php echo e(route('attendances.destroy', $attendance->attendance_id)); ?>" method="POST" onsubmit="return confirm('Are you sure you want to delete this record?');" class="m-0 p-0 inline-block">
                              <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\xampp\htdocs\school_management_system\resources\views/attendances/index.blade.php ENDPATH**/ ?>