...
<?php endif; ?>
                    ...
                    <div class="flex flex-row items-center justify-between w-full text-sm pt-2">
                        ...
                        <?php if(Route::has('password.request')): ?>
                            <a class="text-blue-400 hover:text-blue-300 transition duration-150 underline decoration-dotted" href="<?php echo e(route('password.request')); ?>">
                                Forgot password?
                            </a>
                        <?php endif; ?>
                    </div>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\school_management_system\resources\views/auth/login.blade.php ENDPATH**/ ?>