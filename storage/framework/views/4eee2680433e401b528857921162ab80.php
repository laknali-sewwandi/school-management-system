    ...
    <div class="min-h-screen flex">
        ...
        <div class="flex-1 p-10 overflow-y-auto bg-slate-50">
            ...
            <div class="flex justify-between items-center mb-10">
                ...
                <a href="<?php echo e(route('students.create')); ?>" class="bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white font-bold py-3.5 px-6 rounded-xl shadow-lg transition-all duration-300 flex items-center transform hover:-translate-y-1">
                    <i class="fa-solid fa-user-plus mr-2"></i> Add New Student
                </a>
            </div>

            <form action="<?php echo e(route('students.index')); ?>" method="GET" class="mb-8 bg-white p-3 pr-4 rounded-2xl shadow-md border border-slate-100 flex gap-3 items-center">
                <div class="relative flex-1 group">
                    <i class="fa-solid fa-magnifying-glass absolute left-5 top-1/2 transform -translate-y-1/2 text-slate-400"></i>
                    <input type="text" name="search" value="<?php echo e($search ?? ''); ?>" placeholder="Search students by name or contact number..." 
                ...
                <?php if(isset($search) && $search != ''): ?>
                    <a href="<?php echo e(route('students.index')); ?>" class="bg-red-50 text-red-600 px-6 py-3 rounded-xl font-bold text-sm flex items-center">
                ...
                <table class="min-w-full text-left border-collapse">
                    ...
                    <tbody class="text-slate-700 text-sm divide-y divide-slate-50">
                        ...
                        <tr class="hover:bg-emerald-50/40 transition">
                            <td class="px-8 py-5 font-bold text-slate-500"><?php echo e($student->student_id); ?></td>
                            <td class="px-8 py-5">
                                <div class="flex items-center">
                                    ...
                                    <span class="font-extrabold text-slate-800"><?php echo e($student->name); ?></span>
                                </div>
                            </td>
                            <td class="px-8 py-5"><?php echo e($student->contact); ?></td>
                            
                            <td class="px-8 py-5 w-48">
                                <div class="flex items-center justify-between mb-1.5">
                                    <span class="text-xs font-black text-slate-700"><?php echo e(number_format($student->attendance_percentage, 0)); ?>%</span>
                                </div>
                                <div class="w-full bg-slate-200 rounded-full h-2 shadow-inner">
                                    <div class="h-2 rounded-full transition-all duration-500 <?php echo e($student->attendance_percentage >= 75 ? 'bg-emerald-500' : ($student->attendance_percentage >= 50 ? 'bg-amber-500' : 'bg-rose-500')); ?>" 
                            ...
                            <td class="px-8 py-5">
                                <div class="flex justify-center gap-3">
                                    ...
                                    <a href="<?php echo e(route('students.show', $student->student_id)); ?>" class="text-emerald-600 hover:text-white bg-emerald-50 hover:bg-emerald-600 p-2.5 rounded-xl transition-all" title="View Profile">
                                        <i class="fa-solid fa-eye w-4"></i>
                                    </a>

                                    <a href="<?php echo e(route('students.edit', $student->student_id)); ?>" class="text-blue-600 hover:text-white bg-blue-50 hover:bg-blue-600 p-2.5 rounded-xl transition-all" title="Edit Student">
                                        <i class="fa-solid fa-pen-to-square w-4"></i>
                                    </a>

                                    <form action="<?php echo e(route('students.destroy', $student->student_id)); ?>" method="POST" onsubmit="return confirm('Are you sure you want to delete this student?');" class="m-0 p-0 inline-block">
                                        <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\xampp\htdocs\school_management_system\resources\views/students/index.blade.php ENDPATH**/ ?>