...
<head>
    ...
    <title>Add Subject - School MS</title>
    ...
    <div class="min-h-screen flex">
        ...
        <div class="flex-1 p-10 bg-slate-50">
            <div class="bg-white rounded-3xl shadow-lg border border-slate-100 overflow-hidden relative max-w-2xl mx-auto mt-10">
                ...
                <form action="<?php echo e(route('subjects.store')); ?>" method="POST" class="p-10">
                    <?php echo csrf_field(); ?>
                    <h2 class="text-2xl font-extrabold text-slate-800 mb-6"><i class="fa-solid fa-book text-pink-600 mr-2"></i> Add New Subject</h2>
                    
                    <div class="space-y-6 mb-8">
                        <div>
                            <label class="block text-sm font-bold text-slate-700 mb-2">Subject Name <span class="text-red-500">*</span></label>
                            <input type="text" name="subject_name" required placeholder="e.g. Mathematics" class="w-full px-4 py-3.5 rounded-xl border border-slate-200 focus:outline-none focus:border-pink-500 bg-slate-50 focus:bg-white text-sm font-medium">
                        </div>
                    ...
                    <div class="flex justify-end gap-4">
                        ...
                        <button type="submit" class="bg-pink-600 hover:bg-pink-700 text-white font-bold py-3.5 px-8 rounded-xl shadow-lg">Save Subject</button>
                    </div>
                </form>
            </div>
        </div>
...
</html><?php /**PATH C:\xampp\htdocs\school_management_system\resources\views/subjects/create.blade.php ENDPATH**/ ?>