        ...
        <div class="flex-1 p-10 overflow-y-auto bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] bg-fixed">
            ...
            <div class="flex justify-between items-center mb-10">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-slate-500 mt-1 text-sm font-medium">Update the information for <?php echo e($teacher->name); ?></p>
                    </div>
                </div>
                
                <a href="<?php echo e(route('teachers.index')); ?>" class="bg-white border border-slate-200 text-slate-700 hover:bg-slate-100 hover:text-blue-700 font-bold py-2.5 px-6 rounded-xl shadow-sm transition-all duration-300 flex items-center transform hover:-translate-x-1">
            ...
            <div class="bg-white rounded-3xl shadow-xl shadow-slate-200/50 border border-slate-100 max-w-4xl relative overflow-hidden">
                ...
                <div class="p-8 sm:p-12">
                    <form action="<?php echo e(route('teachers.update', $teacher->teacher_id)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-7 mb-10">
                            ...
                            <div class="col-span-1 md:col-span-2">
                                ...
                                <div class="relative group">
                                    ...
                                    <input type="text" id="name" name="name" value="<?php echo e($teacher->name); ?>" required 
                            ...
                            <div>
                                ...
                                <div class="relative group">
                                    ...
                                    <input type="text" id="contact" name="contact" value="<?php echo e($teacher->contact); ?>" required 
                                           class="w-full pl-11 pr-4 py-3.5 rounded-xl border border-slate-200 focus:outline-none focus:border-amber-500 focus:ring-4 focus:ring-amber-500/10 bg-slate-50 focus:bg-white text-slate-800 transition-all text-sm font-medium">
                                </div>
                            </div>
            ...
            <option value="Science" <?php echo e($teacher->subject == 'Science' ? 'selected' : ''); ?>>Science</option>
            <option value="Mathematics" <?php echo e($teacher->subject == 'Mathematics' ? 'selected' : ''); ?>>Mathematics</option>
            <option value="History" <?php echo e($teacher->subject == 'History' ? 'selected' : ''); ?>>History</option>
            <option value="English" <?php echo e($teacher->subject == 'English' ? 'selected' : ''); ?>>English</option>
            <option value="Sinhala" <?php echo e($teacher->subject == 'Sinhala' ? 'selected' : ''); ?>>Sinhala</option>
            <option value="Commerce" <?php echo e($teacher->subject == 'Commerce' ? 'selected' : ''); ?>>Commerce</option>
            <option value="Dance" <?php echo e($teacher->subject == 'Dance' ? 'selected' : ''); ?>>Dance</option>
            <option value="Geography" <?php echo e($teacher->subject == 'Geography' ? 'selected' : ''); ?>>Geography</option>
            <option value="Engineering Technology" <?php echo e($teacher->subject == 'Engineering Technology' ? 'selected' : ''); ?>>Engineering Technology</option>
            <option value="Science for Technology" <?php echo e($teacher->subject == 'Science for Technology' ? 'selected' : ''); ?>>Science for Technology</option>
            <option value="Information Technology" <?php echo e($teacher->subject == 'Information Technology' ? 'selected' : ''); ?>>Information Technology</option>
        </select>
                        ...
                        <div class="pt-6 border-t border-slate-100 flex items-center justify-end gap-5">
                            <a href="<?php echo e(route('teachers.index')); ?>" class="px-6 py-3.5 rounded-xl text-slate-500 hover:bg-slate-100 hover:text-slate-800 font-bold transition-colors text-sm flex items-center">
                                Cancel
                            </a>
...
</html><?php /**PATH C:\xampp\htdocs\school_management_system\resources\views/teachers/edit.blade.php ENDPATH**/ ?>