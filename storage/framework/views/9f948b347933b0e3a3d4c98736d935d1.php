    ...
    <div class="min-h-screen flex">
        ...
        <div class="flex-1 p-10 overflow-y-auto bg-slate-50">
            ...
            <div class="flex justify-between items-center mb-10">
                ...
                <a href="<?php echo e(route('students.index')); ?>" class="bg-white border border-slate-200 text-slate-700 hover:bg-slate-100 font-bold py-2.5 px-5 rounded-xl shadow-sm transition-all flex items-center text-sm">
                ...
                <div class="bg-white rounded-3xl shadow-lg border border-slate-100 overflow-hidden relative">
                    ...
                    <div class="p-10">
                        <div class="flex items-center gap-8 mb-10 pb-10 border-b border-slate-100">
                            ...
                            <div>
                                <h1 class="text-3xl font-black text-slate-800 mb-2"><?php echo e($student->name); ?></h1>
                                <span class="bg-slate-100 text-slate-600 px-4 py-1.5 rounded-lg text-sm font-bold tracking-wide">Student ID: <?php echo e($student->student_id); ?></span>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                            ...
                            <div class="space-y-5 border-r border-slate-100 pr-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm font-black text-slate-700"><?php echo e($student->contact ?? 'N/A'); ?></p>
                                </div>
                                <div>
                                    <p class="text-xs font-bold text-slate-400 uppercase tracking-wider mb-1">Date of Birth</p>
                                    <p class="text-sm font-black text-slate-700"><?php echo e($student->dob ?? 'N/A'); ?></p>
                                </div>
                                <div>
                                    <p class="text-xs font-bold text-slate-400 uppercase tracking-wider mb-1">Address</p>
                                    <p class="text-sm font-black text-slate-700"><?php echo e($student->address ?? 'N/A'); ?></p>
                                </div>
                            </div>
                            ...
                            <div class="space-y-5 border-r border-slate-100 pr-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm font-black text-slate-700">
                                        <?php echo e($student->parent ? $student->parent->name : 'No Parent Assigned'); ?>
                                ...
                                <div>
                                    ...
                                    <p class="text-sm font-black text-slate-700">
                                        ...
                                        <?php echo e($student->parent ? $student->parent->contact : 'N/A'); ?>
                                ...
                                <div>
                                    ...
                                    <p class="text-sm font-medium text-slate-500">
                                        <?php echo e($student->parent_id ?? 'N/A'); ?>
                            ...
                            <div class="space-y-5 bg-slate-50 p-6 rounded-2xl border border-slate-100 h-fit">
                                ...
                                <div>
                                    <div class="flex items-center justify-between mb-2">
                                        ...
                                        <span class="text-sm font-black text-slate-800"><?php echo e(number_format($student->attendance_percentage, 0)); ?>%</span>
                                    </div>
                                    <div class="w-full bg-slate-200 rounded-full h-2.5 shadow-inner mb-2">
                                        <div class="h-2.5 rounded-full transition-all duration-500 <?php echo e($student->attendance_percentage >= 75 ? 'bg-emerald-500' : ($student->attendance_percentage >= 50 ? 'bg-amber-500' : 'bg-rose-500')); ?>" 
                                             style="width: <?php echo e($student->attendance_percentage); ?>%">
                                        </div>
                                    </div>
                                    <p class="text-[11px] font-bold text-slate-400 text-right">
                                        <?php if($student->attendance_percentage >= 75): ?> Good Standing
                                        <?php elseif($student->attendance_percentage >= 50): ?> Needs Improvement
                                        <?php else: ?> Critical Warning
                                        <?php endif; ?>
                                    </p>
                                </div>
                            </div>
...
</html><?php /**PATH C:\xampp\htdocs\school_management_system\resources\views/students/show.blade.php ENDPATH**/ ?>