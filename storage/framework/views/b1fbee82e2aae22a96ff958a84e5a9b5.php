    ...
    <div class="min-h-screen flex">
        ...
        <div class="flex-1 p-10 overflow-y-auto bg-slate-50">
            ...
            <div class="flex justify-between items-center mb-10">
                ...
                <a href="<?php echo e(route('attendances.index')); ?>" class="bg-white border border-slate-200 text-slate-700 hover:bg-slate-100 font-bold py-2.5 px-5 rounded-xl shadow-sm transition-all flex items-center text-sm">
                ...
                <div class="bg-white p-8 rounded-3xl shadow-md border border-slate-100 mb-8 flex flex-col md:flex-row gap-6 relative overflow-hidden">
                        ...
                        <div class="relative">
                            ...
                            <select name="teacher_id" required class="w-full pl-11 pr-4 py-3.5 rounded-xl border border-slate-200 focus:outline-none focus:border-orange-500 bg-slate-50 focus:bg-white text-sm font-medium text-slate-700">
                                ...
                                <?php $__currentLoopData = $teachers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $teacher): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($teacher->teacher_id); ?>"><?php echo e($teacher->name); ?></option>
                    ...
                    <div class="flex-1">
                        ...
                        <div class="relative">
                            ...
                            <input type="date" name="date" required value="<?php echo e(date('Y-m-d')); ?>" class="w-full pl-11 pr-4 py-3.5 rounded-xl border border-slate-200 focus:outline-none focus:border-orange-500 bg-slate-50 focus:bg-white text-sm font-medium text-slate-700">
                        </div>
                    </div>
                </div>
                                ...
                                <td class="px-8 py-4">
                                    <div class="flex justify-center gap-4">
                                        <label class="cursor-pointer flex items-center gap-2 bg-emerald-50 text-emerald-700 px-4 py-2 rounded-xl border border-emerald-200 hover:bg-emerald-100 transition">
                                            <input type="radio" name="statuses[<?php echo e($student->student_id); ?>]" value="Present" checked class="w-4 h-4 text-emerald-600 focus:ring-emerald-500 border-gray-300">
                                        ...
                                        <label class="cursor-pointer flex items-center gap-2 bg-rose-50 text-rose-700 px-4 py-2 rounded-xl border border-rose-200 hover:bg-rose-100 transition">
                                            <input type="radio" name="statuses[<?php echo e($student->student_id); ?>]" value="Absent" class="w-4 h-4 text-rose-600 focus:ring-rose-500 border-gray-300">
                                        ...
                                        <label class="cursor-pointer flex items-center gap-2 bg-amber-50 text-amber-700 px-4 py-2 rounded-xl border border-amber-200 hover:bg-amber-100 transition">
                                            <input type="radio" name="statuses[<?php echo e($student->student_id); ?>]" value="Late" class="w-4 h-4 text-amber-600 focus:ring-amber-500 border-gray-300">
...
</html><?php /**PATH C:\xampp\htdocs\school_management_system\resources\views/attendances/create.blade.php ENDPATH**/ ?>