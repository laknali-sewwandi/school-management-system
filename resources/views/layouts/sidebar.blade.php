...
<div class="w-64 bg-slate-900 text-slate-300 flex flex-col h-screen sticky top-0 shadow-xl">
    ...
    <div class="flex-1 px-4 py-6 space-y-7 overflow-y-auto custom-scrollbar">
        ...
        <div>
            ...
            <a href="/dashboard" class="flex items-center gap-3 px-4 py-3 rounded-xl font-bold text-sm transition-all {{ request()->is('dashboard') ? 'bg-blue-600 text-white shadow-md shadow-blue-600/20' : 'text-slate-400 hover:bg-slate-800 hover:text-slate-200' }}">
        ...
        <div>
            ...
            <div class="space-y-1">
                <a href="{{ route('classes.index') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl font-bold text-sm transition-all {{ request()->routeIs('classes.*') ? 'bg-blue-600 text-white shadow-md' : 'text-slate-400 hover:bg-slate-800 hover:text-slate-200' }}">
                    <i class="fa-solid fa-school text-lg"></i> Classes
                </a>
                <a href="/subjects" class="flex items-center gap-3 px-4 py-3 rounded-xl font-bold text-sm transition-all {{ request()->is('subjects*') ? 'bg-blue-600 text-white shadow-md' : 'text-slate-400 hover:bg-slate-800 hover:text-slate-200' }}">
        ...
        <div>
            ...
            <div class="space-y-1">
                <a href="/teachers" class="flex items-center gap-3 px-4 py-3 rounded-xl font-bold text-sm transition-all {{ request()->is('teachers*') ? 'bg-blue-600 text-white shadow-md' : 'text-slate-400 hover:bg-slate-800 hover:text-slate-200' }}">
                    <i class="fa-solid fa-chalkboard-user text-lg"></i> Teachers
                </a>
                <a href="/students" class="flex items-center gap-3 px-4 py-3 rounded-xl font-bold text-sm transition-all {{ request()->is('students*') ? 'bg-blue-600 text-white shadow-md' : 'text-slate-400 hover:bg-slate-800 hover:text-slate-200' }}">
                    <i class="fa-solid fa-user-graduate text-lg"></i> Students
                </a>
                <a href="/parents" class="flex items-center gap-3 px-4 py-3 rounded-xl font-bold text-sm transition-all {{ request()->is('parents*') ? 'bg-blue-600 text-white shadow-md' : 'text-slate-400 hover:bg-slate-800 hover:text-slate-200' }}">
        ...
        <div>
            ...
            <div class="space-y-1">
                <a href="{{ route('attendances.index') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl font-bold text-sm transition-all {{ request()->routeIs('attendances.*') ? 'bg-blue-600 text-white shadow-md' : 'text-slate-400 hover:bg-slate-800 hover:text-slate-200' }}">
                    <i class="fa-solid fa-calendar-check text-lg"></i> Attendance
                </a>
                <a href="/marks" class="flex items-center gap-3 px-4 py-3 rounded-xl font-bold text-sm transition-all {{ request()->is('marks*') ? 'bg-blue-600 text-white shadow-md' : 'text-slate-400 hover:bg-slate-800 hover:text-slate-200' }}">
