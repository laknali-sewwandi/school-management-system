...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; padding: 20px;">
    <div style="max-width: 600px; margin: 0 auto; border: 1px solid #e2e8f0; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.1);">
        ...
        <div style="padding: 24px; background-color: #ffffff;">
            ...
            <p>This is an automated notification from the School Management System to inform you regarding the attendance of your child, <strong>{{ $student->name }}</strong>.</p>
            ...
            <div style="background-color: #fff1f2; border-left: 4px solid #e11d48; padding: 15px; margin: 20px 0; border-radius: 4px;">
                <p style="margin: 0; font-size: 16px; color: #9f1239;">
                    Current Attendance Rate: <strong style="font-size: 20px;">{{ number_format($percentage, 0) }}%</strong>
                </p>
            ...
            <p style="font-size: 12px; color: #718096; text-align: center;">School Administration Team<br>© {{ date('Y') }} School MS. All rights reserved.</p>
        </div>
    </div>
</body>
</html>