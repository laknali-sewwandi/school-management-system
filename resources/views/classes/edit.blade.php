    ...
    <div class="min-h-screen flex">
        ...
        <div class="flex-1 p-10 overflow-y-auto bg-slate-50">
            ...
            <div class="bg-white rounded-3xl shadow-lg border border-slate-100 overflow-hidden relative max-w-4xl">
                ...
                <form action="{{ route('classes.update', $schoolClass->class_id) }}" method="POST" class="p-10">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="class_name" value="{{ $schoolClass->class_name }}" required class="w-full pl-11 pr-4 py-3.5 rounded-xl border border-slate-200 focus:outline-none focus:border-violet-500 focus:ring-4 focus:ring-violet-500/10 bg-slate-50 focus:bg-white text-sm font-medium transition-all text-slate-700">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="section" value="{{ $schoolClass->section }}" required class="w-full pl-11 pr-4 py-3.5 rounded-xl border border-slate-200 focus:outline-none focus:border-violet-500 focus:ring-4 focus:ring-violet-500/10 bg-slate-50 focus:bg-white text-sm font-medium transition-all text-slate-700">
                            </div>
                        </div>
                            ...
                            <div class="relative">
                                ...
                                <select name="teacher_id" class="w-full pl-11 pr-4 py-3.5 rounded-xl border border-slate-200 focus:outline-none focus:border-violet-500 focus:ring-4 focus:ring-violet-500/10 bg-slate-50 focus:bg-white text-sm font-medium transition-all text-slate-700 appearance-none">
                                    ...
                                    @foreach($teachers as $teacher)
                                        <option value="{{ $teacher->teacher_id }}" {{ $schoolClass->teacher_id == $teacher->teacher_id ? 'selected' : '' }}>
