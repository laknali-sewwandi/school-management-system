        ...
        <div class="flex-1 p-10 overflow-y-auto bg-gradient-to-br from-slate-50 to-amber-50/30">
            <div class="max-w-3xl mx-auto">
                ...
                <div class="bg-white rounded-3xl shadow-lg border border-slate-100 p-8">
                    <form action="{{ route('parents.update', $parent->parent_id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="email" name="email" value="{{ $parent->email }}" placeholder="e.g. parent@gmail.com" 
                                           class="w-full pl-11 pr-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all">
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <textarea name="address" rows="3" 
                                              class="w-full pl-11 pr-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all">{{ $parent->address }}</textarea>
                                </div>
                            </div>
                        </div>
