        ...
        <div class="flex-1 p-10 overflow-y-auto bg-slate-50">
            <div class="max-w-3xl mx-auto">
                ...
                <div class="flex justify-between items-center mb-8">
                    ...
                    <a href="{{ route('parents.index') }}" class="bg-white border border-slate-200 text-slate-700 hover:bg-slate-100 hover:text-indigo-600 font-bold py-2.5 px-5 rounded-xl shadow-sm transition-all flex items-center text-sm">
